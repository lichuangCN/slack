...
public class LunarSolarConverter {
    ...
    public static class Lunar {
        ...
        private Lunar(int lunarYear, int lunarMonth, int lunarDay) {
    ...
    public static class Solar {
        ...
        private Solar(int solarYear, int solarMonth, int solarDay) {
    ...
    public static Solar LunarToSolar(int lunarYear, int lunarMonth, int lunarDay) {
        Lunar lunar = new Lunar(lunarYear, lunarMonth, lunarDay);
        return LunarToSolar(lunar);
    }

    private static Solar LunarToSolar(Lunar lunar) {
    ...
    private static Lunar SolarToLunar(Solar solar) {
